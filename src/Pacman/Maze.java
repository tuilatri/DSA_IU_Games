...
public class Maze extends JPanel {
    ...
    private Cell[][] cells;
    int tileWidth;                                      // the width of the map in tiles (NOT pixels)
    int tileHeight;                                     // the height of the map in tiles (NOT pixels)
    private Pacman pacman;                              //initialising pacman
    private int pacmanInitialRow = 20;
    private int pacmanInitialColumn = 13;
    private Ghost ghost0;                               //initialising ghosts
    private Ghost ghost1;
    private Ghost ghost2;
    private Ghost ghost3;
    int ghostInitialRow = 23;
    int ghostInitialCol = 10;
    private boolean showHighScore = false;              //declaring various variables
    ...
    private int[] highScores = new int[5];              //array of highscores
    private int[] tempHighScores = new int[6];
    private FileInputStream scoreFile;                  //file and applet declaration for audio
    File scoringFile;
